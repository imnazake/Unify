...
set "PLUGIN_PATH=C:\Users\Nazake\Documents\Unreal Projects\Demos\Unify_5.4\Plugins\GameplayContainers"
set "UAT_PATH=D:\Program Files\Epic Games\UE_5.4\Engine\Build\BatchFiles\RunUAT.bat"

set "PACKAGE_FOLDER_NAME=GC_Distribution_Win64_UE5.4"
