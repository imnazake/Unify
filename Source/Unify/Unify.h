...
/**
 * This macro controls whether the project will be compiled with the necessary configurations for using Gameplay Containers.
 *
 ...
 * Set to 1 to enable the setup, or 0 to disable it.  
 */
#define COMPILE_GAMEPLAY_INTERACTION 0
